...
export const useCases: UseCase[] = [
  ...
  {
    slug: 'react-icons',
    name: 'Best React Icon Libraries',
    description: 'The top free icon libraries built specifically for React, Next.js, and Remix applications.',
    ...
    keywords: ['react icons', 'best react icon library', 'nextjs icons', 'react svg icons', 'open source react icons'],
    recommendedLibraries: ['lucide-icons', 'radix-icons', 'heroicons'],
    whyItMatters: 'Using raw SVGs in React can clutter your JSX and cause performance issues if not properly memoized. Purpose-built React icon libraries export each icon as a highly optimized, tree-shakable React component, drastically improving both your developer experience and your application bundle size.',
    designTips: [
    ...
    mustHaveIcons: ['home', 'user', 'settings', 'search', 'menu', 'x', 'chevron-down', 'arrow-right'],
    avoidMistakes: [
  ...
  {
    slug: 'tailwind-icons',
    name: 'Icons for Tailwind CSS',
    description: 'Icon libraries that integrate perfectly with Tailwind CSS utility classes and styling paradigms.',
    ...
    keywords: ['tailwind icons', 'icons for tailwind css', 'tailwind svg icons', 'heroicons tailwind', 'free tailwind icons'],
    recommendedLibraries: ['heroicons', 'lucide-icons', 'tabler-icons'],
    whyItMatters: 'If an icon library does not support "currentColor", you will find yourself writing custom CSS overrides just to change an icon\'s hover state or dark mode appearance. Libraries built with Tailwind in mind allow you to control every aspect of the icon (size, color, opacity, transitions) using the exact same utility classes you use for your typography.',
    designTips: [
    ...
    mustHaveIcons: ['check', 'x', 'chevron-right', 'chevron-down', 'arrow-right', 'external-link'],
    avoidMistakes: [
  ...
  {
    slug: 'vue-icons',
    name: 'Best Vue Icon Libraries',
    description: 'Top free icon libraries with native support for Vue 3 and the Composition API.',
    longDescription: 'Vue developers need icon libraries that play nicely with Vue 3\'s Composition API, Vite bundlers, and Nuxt. While you can use generic SVG files in Vue, native Vue icon packages offer prop validation, proper TypeScript support, and seamless integration into single-file components (.vue files).',
    keywords: ['vue icons', 'vue 3 icons', 'best vue icon library', 'nuxt icons', 'open source vue icons'],
    recommendedLibraries: ['lucide-icons', 'heroicons', 'tabler-icons'],
    whyItMatters: 'Native Vue icon libraries allow you to pass dynamic props safely and take advantage of Vue\'s highly optimized rendering engine. They ensure your icons are tree-shakable and do not bloat your final Vite bundle.',
    designTips: [
    ...
    mustHaveIcons: ['home', 'user', 'settings', 'search', 'menu', 'x'],
    avoidMistakes: [
